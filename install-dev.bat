...
cmd.exe /c sfdx force:user:permset:assign -n Dynamic_Interactions_Demo -u %ORG_ALIAS%
call :checkForError
@echo:
...
if ["%errorlevel%"]==["0"] (
  ...
  @echo:
  cmd.exe /c sfdx force:org:open -p lightning/n/Dynamic_Interactions_Demo -u %ORG_ALIAS%
)
